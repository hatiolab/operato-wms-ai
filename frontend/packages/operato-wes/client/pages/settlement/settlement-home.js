...
class SettlementHome extends localize(i18next)(PageView) {
  static get styles() {
    return [
      css`
        :host {
  ...
  render() {
    return html`
      <h2>정산 관리</h2>
      <p page-description>이 메뉴는 Operato WES 정산을 위한 메뉴입니다.</p>

      <img src="/assets/images/outbound/outbound-home.png" />
    `
  }
...
window.customElements.define('settlement-home', SettlementHome)
