 ...
 * @description [Goods Receipt] Product Base Work Page
 */
export class GiProductWorkPage extends GristRenderMixin(p13n(localize(i18next)(PageView))) {
  /**
...
customElements.define('gi-product-work-page', GiProductWorkPage)
