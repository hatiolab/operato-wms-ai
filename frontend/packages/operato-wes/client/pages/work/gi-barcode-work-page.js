 ...
 * @description [Goods Issue] Barcode Base Work Page
 */
export class GiBarcodeWorkPage extends GristRenderMixin(p13n(localize(i18next)(PageView))) {
  /**
...
customElements.define('gi-barcode-work-page', GiBarcodeWorkPage)
