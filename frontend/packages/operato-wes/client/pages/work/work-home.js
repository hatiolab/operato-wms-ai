...
class WorkHome extends p13n(localize(i18next)(PageView)) {
  static get styles() {
    return [
      css`
        :host {
  ...
  render() {
    return html`
      <h2>작업 화면</h2>
      <p page-description>이 메뉴는 Operato WES 작업을 위한 메뉴입니다.</p>
...
window.customElements.define('work-home', WorkHome)
