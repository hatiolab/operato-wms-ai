 ...
 */
export class InventoryReleases extends GristRenderMixin(p13n(localize(i18next)(PageView))) {
  ...
  /**
   * @description release inventory data
   ****************************************
   */
   async release() {
     let records = this.grist.data.records ? this.grist.data.records : []
...
customElements.define('inventory-releases', InventoryReleases)
