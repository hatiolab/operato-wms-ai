 ...
 * B2B 용 자동 웨이브 생성 Job
 *
 * Quartz 스케줄러에 의해 트리거되며, StoragePolicy B2B 웨이브 관련 설정값을 읽어
...
public class OmsB2BWaveJob extends AbstractJob {
    /**
     * QueryManager
     */
    @Autowired
    ...
    private Map<String, Object> createAutoWave(StoragePolicy policy) {
        ...
        // 3. 설정값 조회
        String groupByStr = policy.getB2bWaveGroupBy();
        int maxOrderCount = policy.getB2bWaveTriggerCnt();
