package operato.wms.parcel.entity;
...
public class CourierContract extends xyz.elidom.orm.entity.basic.ElidomStampHook {
	...
	/**
	 * 계약 서브 번호 - 계약 내 세부 구분 번호 (예: 계약 갱신 또는 채널 분기 시 사용)
	 */
	@Column(name = "contract_sub_no", length = 20)
	...
	/**
	 * API Key - 택배사 연동 API 인증 키
	 */
	@Column(name = "api_key", length = 50)
	private String apiKey;

	/**
	 * API 기본 URL - 택배사 연동 API 기본 엔드포인트 URL
	 */
	...
	/**
	 * 기본 여부 - true이면 도메인 내 해당 택배사의 기본 계약으로 사용
	 */
	...
	public String getContractSubNo() {
		return contractSubNo;
	}

	public void setContractSubNo(String contractSubNo) {
		this.contractSubNo = contractSubNo;
	}
