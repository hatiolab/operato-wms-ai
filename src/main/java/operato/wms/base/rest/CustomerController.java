...
public class CustomerController extends AbstractRestService {
     ...
     */
    public static final String TRX_CUST_PRE_MULTIPLE_UPDATE = "diy-cust-pre-multiple-update";
    /**
     * 커스텀 서비스 - MultipleUpdate 후 처리
     */
    public static final String TRX_CUST_POST_MULTIPLE_UPDATE = "diy-cust-post-multiple-update";
	...
	public Boolean multipleUpdate(@RequestBody List<Customer> list) {
        ...
        this.customSvc.doCustomService(Domain.currentDomainId(), TRX_CUST_PRE_MULTIPLE_UPDATE, custSvcParams);
        
        // 2. 업데이트 
        this.cudMultipleData(this.entityClass(), list);
        
        // 3. 후 처리 커스텀 서비스 호출
        this.customSvc.doCustomService(Domain.currentDomainId(), TRX_CUST_POST_MULTIPLE_UPDATE, custSvcParams);
