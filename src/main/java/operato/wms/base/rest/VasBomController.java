...
@ServiceDesc(description="VasBom Service API")
public class VasBomController extends AbstractRestService {
	...
	public VasBom findOne(@PathVariable("id") String id) {
	...
	public VasBom create(@RequestBody VasBom input) {
		return this.createOne(input);
	}

	@PutMapping(value="/{id}", consumes=MediaType.APPLICATION_JSON_VALUE, produces=MediaType.APPLICATION_JSON_VALUE)
	@ApiDesc(description="Update")
	public VasBom update(@PathVariable("id") String id, @RequestBody VasBom input) {
	...
	public Boolean multipleUpdate(@RequestBody List<VasBom> list) {
	...
	public List<VasBomItem> findVasBomItem(@PathVariable("id") String id) {
		xyz.elidom.dbist.dml.Query query = new xyz.elidom.dbist.dml.Query();
		query.addFilter(new Filter("vasBomId", id));
	...
	public List<VasBomItem> updateVasBomItem(@PathVariable("id") String id, @RequestBody List<VasBomItem> list) {
		for(VasBomItem item : list) {
			item.setVasBomId(id);
		}
		
		this.cudMultipleData(VasBomItem.class, list);
		return this.findVasBomItem(id);
	}
