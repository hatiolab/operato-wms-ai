...
> 최종 업데이트: 2026-06-23 | Week 2~3 작업 84% 완료 (74 / 88)
...
| **OMS** (주문관리) | 90% | 85% | 자동 웨이브·취소 백프로세스 완료, 웨이브 확정 팝업 연동 미완 |
...
[커스터마이징 4건]
- W23-CUST-LK-4: B2B 주문 프로세스 커스터마이징
...
| 3 | W23-WA-3 | 웨이브 확정 팝업 연동 | 피킹 유형, 배송 유형, 택배사 코드, 검수 여부, 작업자 수 처리 | `FulfillmentTransactionController` | 2026-04-29 | 100% | ☑ | |
