...
> 최종 업데이트: 2026-04-30 | Week 2~3 작업 77% 완료 (37 / 48)
...
| **STOCK** (재고) | 92% | 80% | 재고 이동·조회 PDA 완료, 재고 분할/병합·실사 PDA 미완 |
| **OMS** (주문관리) | 90% | 85% | 자동 웨이브·취소 백프로세스 완료, 웨이브 확정 팝업 연동 미완 |
| **FULFILLMENT** (피킹/포장) | 95% | 95% | PC·PDA 피킹/포장 전체 완료, 재고 바코드·sku-barcode-input 연동 |
...
```
[잔여 11건]
- W23-SF-6: 재고 분할/병합 PDA 화면 (pda-stock-split-merge.js)
...
| W23-SF-6 | 재고 분할 / 병합 (PDA) | `pda-stock-split-merge.js` | PDA 바코드 스캔으로 동일 SKU 재고 분할 / 병합 | 2026-05-02 | 0% | ☐ | |
...
|------|------|
| 전체 작업 수 | 48개 |
| 완료 (☑) | 37개 (W23-SF-1~5·8~12, W23-UA-1~2, W23-SA-1~2, W23-CB-1~3, W23-BF-0~5, W23-DB-1~2, W23-RE-1~2, W23-FL-1~5, W23-IR-1~2, W23-WA-1~2, W23-FR-3) |
| 진행 중 | 0개 |
| 미완료 (☐) | 11개 (W23-SF-6·7, W23-WA-3, W23-VA-1~3, W23-RW-1~2, W23-FR-1~2, W23-ETC-1) |
| 전체 진행율 | 77% (완료 37 / 전체 48) |
