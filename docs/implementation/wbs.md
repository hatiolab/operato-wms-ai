...
|---------|--------|--------|------|--------|--------|------|------|
| W23-SF-1 | 재고 현황 | `stock-inventory-list.js` | 로케이션별·SKU별 재고 조회 (필터: 화주사, 창고, 존) | 2026-04-25 | 0% | ☐ | |
| W23-SF-2 | 수불 현황 | `stock-transaction-list.js` | 기간별 입출고 이력 (inventory_hists 기반) | 2026-04-26 | 0% | ☐ | |
| W23-SF-3 | 재고 실사 목록 | `stock-stocktake-list.js` | 실사 지시 생성/조회/확정 | 2026-04-27 | 0% | ☐ | |
| W23-SF-4 | 재고 이동 | `stock-move-form.js` | 로케이션 간 재고 이동 지시 | 2026-04-28 | 0% | ☐ | |
...
| 작업번호 | 항목 | 내용 | 예정일 | 진행율 | 완료 | 비고 |
|---------|------|------|--------|--------|------|------|
| W23-DB-1 | 기존 테이블 ALTER 마이그레이션 | SKU, Location, Customer, Warehouse, BoxType, CourierContract 신규 컬럼 DDL | 2026-05-07 | 0% | ☐ | |
| W23-DB-2 | 마이그레이션 실행 검증 | 로컬 → 스테이징 순으로 실행 후 무결성 확인 | 2026-05-08 | 0% | ☐ | |
