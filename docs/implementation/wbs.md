...
> 최종 업데이트: 2026-06-23 | Week 2~3 작업 84% 완료 (74 / 88) + CUST-LK-4 75% 진행
...
| **OMS** (주문관리) | 92% | 88% | 자동 웨이브·취소 백프로세스 완료, 웨이브 확정 팝업 연동 완료, B2B 출고 준비 팝업 구현 |
| **FULFILLMENT** (피킹/포장) | 97% | 97% | PC·PDA 피킹/포장 전체 완료, 재고 바코드·sku-barcode-input 연동, B2C/B2B 포장 화면 결품 처리 UI 완료 |
...
[커스터마이징 4건]
- W23-CUST-LK-4: B2B 주문 프로세스 커스터마이징 (75% — 라벨 출력 연동만 잔여)
- W23-CUST-LK-5: B2C 검수, 포장 프로세스 커스터마이징
- W23-CUST-LK-7: B2C 웨이브 별 주문 화면 추가
- W23-CUST-LK-9: B2C 주문 임포트 각 쇼핑몰 별 구현
[택배사 연동 2건]
- W23-CT-LT-4: 대한통운 집하 요청 (예약)
- W23-CT-LT-5: 대한통운 송장 출력
[기타 2건]
- W23-ETC-3: 라벨 프린터 연동
- W23-ETC-4: 상품, 세트 상품 마스터 엑셀 임포트
[재고 부족 대응 2건 — 별도 설계 필요]
...
| W1-F-3 | B2B 피킹 화면 | B2B용 직접 피킹 화면 | 화면 추가 필요 | 2026-06-22 | 0% | ☐ | |
...
|------|------|
| 전체 작업 수 | 26개 |
| 완료 (☑) | 26개 (W1-S-1~4, W1-O-1~6, W1-I-1~2, W1-V-1~2, W1-R-1, W1-F-1~2, W1-ST-1~3, W1-FL-1~6) |
| 진행 중 | 0개 |
| 미시작 | 0개 |
| 전체 진행율 | 100% (완료 26 / 전체 26) |
...
| 5 | W23-ETC-5 | 재고 이력 삭제 | 재고 이력 테이블 삭제, 재고 트랜잭션으로 대체 | 2026-06-30 | 0% | ☐ | |
...
| 4 | W23-CUST-LK-4 | B2B 주문 프로세스 커스터마이징 | 주문 할당 : 주문 확인 자동 처리, 웨이브 없는 피킹 지원, 패킹 스테이션 지정, 라벨 출력 연동 | 2026-05-13 | 75% | ☐ | shipment-order-ready-popup.js 신규 구현: confirm_and_allocate·direct_picking/create_list·패킹 스테이션 지정 완료. 라벨 출력 연동만 잔여 |
...
| 9 | W23-CUST-LK-9 | B2C 주문 임포트 각 쇼핑몰 별 구현 | 쇼핑몰 별 주문 임포트 화면 구현 | 2026-05-18 | 0% | ☐ | |
...
| 4 | W23-CT-LT-4 | 대한통운 연동 - 집하 요청 (예약) | 대한통운 집하 예약 기능 | 2026-06-22 | 0% | ☐ | |
| 5 | W23-CT-LT-5 | 대한통운 연동 - 송장 출력 | 대한통운 송장 출력 기능 | 2026-06-24 | 0% | ☐ | |
...
| 3 | W23-SHORTAGE-3 | 피킹 작업 시 실 재고가 부족시 결품 처리 | 피킹 작업 화면에서 결품 처리 버튼 | 2026-06-24 | 100% | ☑ | B-1: shortItem() 상태 분기 버그 수정, B-2/B-3: createPackingOrders() PICKED+SHORT 포함 |
| 4 | W23-SHORTAGE-4 | 패킹 작업 시 실 재고 부족시 결품 처리 | 패킹 작업 화면에서 결품 처리 버튼 | 2026-06-24 | 100% | ☑ | N-1~N-4: PackingOrder.STATUS_SHORT, completePackingOrder SHORT 분기, 포장 아이템 부족 API, B2C/B2B 포장 화면 [부족 처리] UI |
| 5 | W23-SHORTAGE-5 | 결품 발생한 패킹 정보 모아서 피킹 지시 | 결품 발생한 패킹 주문을 모두 모아서 한 번에 토털 피킹 지시 | 2026-06-24 | 0% | ☐ | |
| 6 | W23-SHORTAGE-6 | 결품 피킹 완료 후 검수/포장 처리 | 결품 피킹 완료 후 검수/포장 처리 | 2026-06-24 | 0% | ☐ | |

### Week 2~3 진행 현황

| 항목 | 수치 |
|------|------|
| 전체 작업 수 | 88개 (3-18 재고 부족 대응 6개 추가) |
| 완료 (☑) | 74개 (W23-SF-1~6·8~12, W23-UA-1~2, W23-SA-1~2, W23-CB-1~3, W23-BF-0~5, W23-DB-1~2, W23-RE-1~2, W23-FL-1~5, W23-IR-1~2, W23-WA-1~2, W23-VA-1~3, W23-RW-1~2, W23-FR-1~2·4, W23-ETC-1~2, W23-CUST-LK-1~3·6·8, W23-CT-LT-0~3, W23-ST-DS-1·3~15, W23-SHORTAGE-1~4) |
| 진행 중 | 0개 |
| 미완료 (☐) | 14개 (W23-SF-7, W23-WA-3, W23-FR-3, W23-ST-DS-2, W23-ETC-3~4, W23-CUST-LK-4~5·7·9, W23-CT-LT-4~5, W23-SHORTAGE-5~6) |
| 전체 진행율 | 84% (완료 74 / 전체 88) |
