...
> 최종 업데이트: 2026-04-29 | Week 2~3 작업 73% 완료 (35 / 48)

### 모듈별 완성도

| 모듈 | 백엔드 | 프론트엔드 | 비고 |
|------|--------|------------|------|
| **BASE** (기준정보) | 98% | 75% | hazmatFlag·WaveGroupBy 필드 추가, 화면 일부 미반영 |
| **INBOUND** (입고) | 95% | 65% | 유통기한 자동계산·검수반려 구현 완료 |
| **STOCK** (재고) | 92% | 70% | 피킹존 제한·위험물·온도 검증·부족재고·재주문점 경고 완료 |
| **OMS** (주문관리) | 90% | 85% | 자동 웨이브·취소 백프로세스 완료, 웨이브 확정 팝업 연동 미완 |
| **FULFILLMENT** (피킹/포장) | 95% | 88% | 피킹 동선 정렬·B2B피킹·재고부족·취소 전체 완료 |
| **VAS** (유통가공) | 75% | 75% | BOM 채번·재고처리 완료, 세트 상품 end-to-end 테스트 미완 |
| **RWA** (반품) | 82% | 80% | SKU명 자동조회 완료, 전체 플로우 테스트 미완 |
...
- W23-VA-1: VAS 세트 조립 재고 처리 end-to-end 테스트
- W23-VA-2: VAS 세트 해체 재고 처리
- W23-VA-3: 피킹 시 세트 상품 처리 정책 결정 및 구현
- W23-RW-1~2: 반품 전체 플로우 테스트
- W23-SF-6: 재고 실사 PDA 화면
...
| W23-SF-8 | PDA 입고, 검수/포장, 실사 등 화면 | `pda-inbound-receiving.js`,`pda-oms-replenish.js`,`pda-fulfillment-picking.js`,`pda-fulfillment-packing.js` | 상품 바코드 스캔 시도 상품을 찾을 수 있도록 (서버에 요청) | 2026-04-29 | 50% | ☐ | |
...
| W23-SF-12 | PDA 출고 피킹 화면 | `pda-fulfillment-picking.js` | 상품 바코드 스캔이 아닌 재고 바코드 스캔으로 피킹하도록 수정 | 2026-04-29 | 0% | ☐ | |
...
|------|------|
| 전체 작업 수 | 48개 |
| 완료 (☑) | 35개 (W23-SF-1~5·9·10·11, W23-UA-1~2, W23-SA-1~2, W23-CB-1~3, W23-BF-0~5, W23-DB-1~2, W23-RE-1~2, W23-FL-1~5, W23-IR-1~2, W23-WA-1~2, W23-FR-3) |
| 진행 중 | 1개 (W23-SF-8 50%) |
| 미완료 (☐) | 12개 (W23-SF-6·7·12, W23-WA-3, W23-VA-1~3, W23-RW-1~2, W23-FR-1~2, W23-ETC-1) |
| 전체 진행율 | 73% (완료 35 / 전체 48) |
