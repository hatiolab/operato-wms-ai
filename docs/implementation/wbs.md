...
> 최종 업데이트: 2026-07-25 | Week 2~3 작업 88% 완료 (94 / 107)
...
| **STOCK** (재고) | 94% | 88% | 재고 이동·조회·분할/병합 PDA 완료, 재고 이동 이력 추적 화면 완료, 재고 실사 PDA 미완 |
| **OMS** (주문관리) | 95% | 90% | 자동 웨이브·취소 백프로세스 완료, B2B 출고 준비 팝업·거래명세서 출력 완료 |
| **FULFILLMENT** (피킹/포장) | 98% | 97% | PC·PDA 피킹/포장 전체 완료, B2C/B2B 포장 화면 결품 처리 UI 완료, 피킹 단계 3단계 부족 처리 완료(W23-SHORTAGE-3 ☑), completePackingOrder() short_qty 누락 버그 설계 확정 |
...
- W23-FR-7: 동적 엑셀 임포트 팝업 묶음 처리 기능 개선 (dynamic-excel-import-popup.js)
[재고 2건]
- W23-ST-DS-2: 재고 조정 이력 엔티티, 화면 정의
- W23-ETC-8: 재고 조정 작업 화면
[커스터마이징 2건]
- W23-CUST-LK-10: 주문 Import 시 상품 매칭 기능
- W23-FL-6: 거래처 별 상품 코드·상품명·발주 수량 매핑 기능
[택배사 연동 2건]
- W23-CT-LT-4: 대한통운 송장 출력
- W23-ETC-3: 라벨 프린터 연동
[기타 2건]
- W23-FL-7: 거래처 별 엑셀 등록 양식 정의
...
| 4 | W23-VA-4 | 세트 상품 해체 시 구성품 누락 수량 관리 | 세트 상품 해체 시 구성품 누락 수량 관리 | | 2026-07-05 | 100% | ☑ | |
...
| 6 | W23-FL-6 | 거래처 별 상품 코드 - 상품명, 발주 수량 매핑 기능 | 거래처 별로 하나의 상품 코드에 대한 명칭과 발주 수량이 다를 수 있으므로 거래처 별로 상품명, 발주 수량을 매핑하는 기능. |  | 2026-07-21 | 0% | ☐ | |
| 7 | W23-FL-7 | 거래처 별 엑셀 등록 양식 정의 | 거래처 별로 발주 양식을 설정하는 기능 |  | 2026-07-25 | 0% | ☐ | |
...
| 5 | W23-FR-5 | 엑셀 템플릿 설정으로 생성하는 기능 | 엑셀 템플릿을 설정 화면에서 설정하여 생성하는 기능 | `ExcelTemplate`, `ExcelTemplateColumn` Entity (otarepo-core) / `ExcelTemplateController`, `ExcelTemplateColumnController`, `ExcelTemplateService` / `excel-template-list.js`, `excel-template-detail.js` (metapage) | 2026-07-17 | 100% | ☑ | |
| 6 | W23-FR-6 | 엑셀 템플릿 설정 기반 엑셀 임포트 처리하는 컴포넌트 | 엑셀 템플릿을 설정 ID로 동적으로 화면 구성 및 임포트 처리하는 팝업 화면 | `dynamic-excel-import-popup.js` (metapage) | 2026-07-17 | 100% | ☑ | |
| 7 | W23-FR-7 | 동적 엑셀 임포트 팝업 컴포넌트 기능 개선 | 건 별로 처리시 성능 이슈가 있고 한꺼번에 모두 처리하면 사용자가 진행 상황을 알 수 없으니 묶어서 처리할 수 있는 기능과 묶음 키를 설정할 수 있는 기능 추가 | `dynamic-excel-import-popup.js` (metapage) | 2026-07-26 | 0% | ☐ | |
...
| 4 | W23-ETC-4 | 상품, 세트 상품 마스터 엑셀 임포트 | 상품, 세트 상품 마스터 엑셀 임포트 | 2026-07-28 | 60% | ☐ | 상품, 로케이션 마스터 임포트 완료 |
...
| 7 | W23-ETC-7 | 입고 주문 수동 생성 기능 | 입고 주문 수동 생성 기능 | 2026-07-01 | 100% | ☑ | |
| 8 | W23-ETC-8 | 재고 조정 작업 화면 | 여러 건의 재고 조정 처리하는 화면 | 2026-06-27 | 0% | ☐ | |
| 9 | W23-ETC-9 | 재고 이력 추적 화면 | 재고 이력 추적 화면 | 2026-07-01 | 100% | ☑ | |
| 10 | W23-ETC-10 | 출고 주문 패턴화 해서 소팅 처리 | 주문 패턴 소팅 순으로 패킹지시서 출력 | 2026-06-29 | 100% | ☑ | |
| 11 | W23-ETC-11 | B2B 출고 주문 수동 생성 기능 | B2B 출고 주문 수동 생성 기능 | 2026-07-04 | 100% | ☑ | |
...
| 7 | W23-CUST-LK-7 | B2C 웨이브 별 주문 화면 추가 | B2C 웨이브 별 주문 화면 추가 | 2026-05-20 | 100% | ☑ | |
| 8 | W23-CUST-LK-8 | 포장 완료 시 출하 완료까지 처리 | 커스텀 서비스 구현 | 2026-05-16 | 100% | ☑ | |
| 9 | W23-CUST-LK-9 | B2C 주문 임포트 각 쇼핑몰 별 구현 | 쇼핑몰 별 주문 임포트 화면 구현 | 2026-06-26 | 100% | ☑ | |
| 10 | W23-CUST-LK-10 | 주문 Import 시 상품 매칭 기능 | 입고, 출고 주문 등록 시 상품 코드, 상품명으로 매칭 불가시 사용자가 직접 수동 매칭하는 기능, 거래처별 상품명, 발주 수량 매핑 별도 관리 | 2026-07-20 | 0% | ☐ | |
...
| 16 | W23-ST-DS-16 | 재고 트랜잭션 수정 | 이동 처리시 분할, 병합이 일어나 추적이 어려움  | 2026-07-04 | 100% | ☑ | |
| 17 | W23-ST-DS-17 | 멀티 재고 생성 | 여러 건 재고를 생성하는 UI | 2026-07-17 | 100% | ☑ | |
...
| 3 | W23-SHORTAGE-3 | 피킹 작업 시 실 재고가 부족시 결품 처리 | 피킹 존에 재고가 있다면 자동 재할당 보충 존에 재고가 있다면 보충 지시 생성 아예 재고가 없으면 작업 화면에 재고 없음 표시 | 2026-06-25 | 100% | ☑ | 설계 리뷰·논리 오류 수정 완료(2026-06-26). N-7 자동 재할당·N-8 보충 지시 생성·N-9 REPLENISH_WAIT 상태·N-10 피킹 UI 구현 필요 |
...
|------|------|
| 전체 작업 수 | 107개 |
| 완료 (☑) | 94개 (W23-SF-1~6·8~15, W23-UA-1~2, W23-SA-1~2, W23-CB-1~3, W23-BF-0~5, W23-DB-1~2, W23-RE-1~2, W23-FL-1~5, W23-IR-1~2, W23-WA-1~4, W23-VA-1~4, W23-RW-1~2, W23-FR-1~2·4, W23-ETC-1~2·5~11, W23-CUST-LK-1~10, W23-CT-LT-0~3, W23-ST-DS-1·3~17, W23-SHORTAGE-1~4) |
| 미완료 (☐) | 13개 (W23-SF-7, W23-FL-6~7, W23-FR-3·7, W23-ST-DS-2, W23-ETC-3~4·8, W23-CUST-LK-10, W23-CT-LT-4, W23-SHORTAGE-5~6) |
| 전체 진행율 | 88% (완료 94 / 전체 107) |
...
| **Week 2~3** | ~3주 | 107개 | 94/107 | **88%** | 화면 완성, 자동화 기능, DB 마이그레이션, 신규 필드 화면 반영, 운영 규칙 구현 |
